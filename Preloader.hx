...
@:font("assets/data/fonts/vcr.ttf") class CustomFont extends Font {}
...
class CustomPreloader extends FlxBasePreloader
{
    ...
    override function create():Void 
    {
        ...
        text = new TextField();
        text.defaultTextFormat = new TextFormat("Friday Night Funkin VCR", Std.int(24 * ratio), 0xffffff, false, false, false, "", "", TextFormatAlign.CENTER);
        ...
        text.text = "Friday Night Funkin (Rag-Engine)";
        addChild(text);
     override function update(Percent:Float):Void
{
    text.text2 = "Loading " + Std.int(Percent * 100) + "%";
